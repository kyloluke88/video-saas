...
func init() {
	config.Add("worker", func() map[string]interface{} {
		...
		return map[string]interface{}{
			...
			"zh_podcast_enabled":                       cast.ToBool(config.Env("ZH_PODCAST_ENABLED", true)),
			"ja_podcast_enabled":                       cast.ToBool(config.Env("JA_PODCAST_ENABLED", true)),
			...
			"tencent_podcast_male_voice_type":          cast.ToInt64(config.Env("TENCENT_PODCAST_MALE_VOICE_TYPE", int64(601008))),
			"tencent_podcast_female_voice_type":        cast.ToInt64(config.Env("TENCENT_PODCAST_FEMALE_VOICE_TYPE", int64(601010))),
			"tencent_podcast_male_speed":               cast.ToFloat64(config.Env("TENCENT_PODCAST_MALE_SPEED", 0.8)),
			"tencent_podcast_female_speed":             cast.ToFloat64(config.Env("TENCENT_PODCAST_FEMALE_SPEED", 0.8)),
			...
			"elevenlabs_podcast_segment_gap_ms":        cast.ToInt(config.Env("ELEVENLABS_PODCAST_SEGMENT_GAP_MS", 220)),
