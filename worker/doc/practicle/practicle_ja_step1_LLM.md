...
"topics": [
    {
        ...
        "duration_minutes": 15,
        "description": "参考以下结构：
        ch_01 ホテルに到着して予約を伝える
        ch_02 名前と予約内容を確認する
        ch_03 パスポートと宿泊者情報を出す
        ch_04 部屋の準備とチェックイン時間を確認する
        ch_05 支払い方法と追加料金を確認する
        ch_06 朝食・Wi-Fi・館内設備を聞く
        ch_07 ルームキーと部屋の使い方を聞く
        ch_08 荷物を預ける・部屋まで運んでもらう
        ch_09 部屋や設備について困ったことを相談する
        ch_10 退房時間と最後の確認をして部屋へ向かう
        "
    }
]
