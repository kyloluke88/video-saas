...
- 不是教材、新闻播报、讲座、采访、客服或主持人面向观众的正式稿；优先互动、反应、共鸣、接话，而不是工整讲解
...
语言风格规则：
- 必须使用像朋友之间日常会说的自然口语，句子要清楚、易懂、适合聊天口播
...
- 不要过度堆砌语气词、长篇连续独白，或让每轮都像在发表观点、下定义、做正式说明
- 不要过度总结、过度解释、过度说教
...
- 5 分钟内容：建议 44 到 60 个 segments
- 10 分钟内容：建议 88 到 120 个 segments
- 15 分钟内容：建议 132 到 180 个 segments
- 20 分钟内容：建议 176 到 240 个 segments
...
- 如果 segment 数量低于当前规则所要求的下限，则视为不合格，必须继续扩写
...
3. 是否已自检当前 target_duration_minutes 对应的 segment 数量，确认达到当前规则要求的区间
