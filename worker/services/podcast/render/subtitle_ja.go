...
func writeJapaneseASSHeader(b *strings.Builder, layout subtitleLayout) {
	...
	b.WriteString("Style: JaActive," + layout.HanziFontName + "," + strconv.Itoa(layout.HanziSize) + "," + layout.HighlightColor + "," + layout.HighlightColor + "," + assColorRGB(0, 0, 0) + ",&H64000000,1,0,0,0,100,100," + assSpacingText(layout.HanziSpacing) + ",0,1,3,0,5,10,10,10,1\n")
