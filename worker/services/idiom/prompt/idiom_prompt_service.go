...
type PromptVisualBible = idiommodel.VisualBible
type PromptObjectRegistry = idiommodel.ObjectRegistry
type PromptBeat = idiommodel.Beat
type PromptActionUnit = idiommodel.ActionUnit
type PromptDialogue = idiommodel.Dialogue
type PromptSoundEffect = idiommodel.SoundEffect
type PromptAudioLayer = idiommodel.AudioLayer
type PromptCameraSpec = idiommodel.CameraSpec
type PromptCast = idiommodel.Cast
type PromptScene = idiommodel.ScenePlan
...
func BuildScenePrompt(scene idiommodel.ScenePlan, characterCatalog, propsCatalog, environmentCatalog map[string]string, visualBible string) string {
