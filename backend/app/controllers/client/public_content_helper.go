...
type PublicPracticalScriptListItem struct {
	ID              uint64     `gorm:"column:id" json:"id"`
	Slug            string     `gorm:"column:slug" json:"slug"`
	Title           string     `gorm:"column:title" json:"title"`
	EnTitle         string     `gorm:"column:en_title" json:"en_title,omitempty"`
...
func listPublishedPracticalScripts(language string, limit int) ([]PublicPracticalScriptListItem, error) {
	query := database.DB.
	...
	var pages []PublicPracticalScriptListItem
