...
import PodcastScriptPageView from "@/features/podcast-script/components/podcast-script-page";
import { getPodcastScriptList, getPodcastScriptPage } from "@/features/podcast-script/api.server";
